        ...
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="w-full max-w-md">
                <div className="flex flex-col items-center gap-2 mb-8 text-white">
                    ...
                    <p className="text-blue-100 font-medium">Next-Generation Clinical Platform</p>
                </div>
                    ...
                    <CardContent>
                        <Tabs defaultValue="patient" className="w-full" onValueChange={(v) => setRole(v as UserRole)}>
                            <TabsList className="grid w-full grid-cols-2 mb-6 h-12 bg-slate-100/50 p-1">
                                <TabsTrigger
                                    value="patient"
                                    className="data-[state=active]:bg-white data-[state=active]:shadow-sm data-[state=active]:text-blue-600 text-sm font-medium rounded-md transition-all"
                                >
